...
anotacaoRoutes.post('/list', ensureAuthenticated, listAnotacaoController.handle)
...
anotacaoRoutes.delete('/:id', ensureAuthenticated, deleteAnotacaoController.handle)
